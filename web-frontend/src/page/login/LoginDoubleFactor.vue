<template>
  <div class="login" id="login">
    <div class="log-bg">
      ...
      <div class="log-logo">双因子认证</div>
    </div>
    <div class="log-email">
      <input type="text" placeholder="双因子" :class="'log-input' + (account==''?' log-input-empty':'')" v-model="account">
      <span class="log-btn" @click="login">登录</span>
    </div>
    ...
    export default {
        ...
        methods:{
            ...
            toLogin(){
                ...
                util.setCookie('session','winsignslogin', expireDays);
                this.isLoging = false;
                //登录成功后
